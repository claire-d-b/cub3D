...
unsigned int	set_texture_sprite(t_player *player, int y, int i)
{
	...
	if (((((y * player->ids.xpm_sprite_w * 4) + (i * 4) + 3))) <= (player->ids.xpm_sprite_w *
	player->ids.xpm_sprite_h * 4) && (((y * player->ids.xpm_sprite_w * 4) + (i * 4))) >= 0)
	{
...
unsigned int	set_texture_north(t_player *player, int y, int i)
{
	...
	(player->ids.xpm_img2_w * player->ids.xpm_img2_h * 4) && (((player->ry * CELL_SIZE * 4) +
	(player->rx * 4))) >= 0)
	{
		player->struct_side.pixel[0] =
