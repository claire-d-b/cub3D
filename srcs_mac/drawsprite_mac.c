...
void	draw_sprite(t_player *player, int i, int j, int count)
{
	...
	|| (int)player->sprite[count][3] - (int)(((player->sprite[count][2] +
	player->sprite[count][6]) / 2) <= 0)) && (!((int)player->sprite[count][7]
	+ (int)(((player->sprite[count][2] + player->sprite[count][6]) / 2) >=
